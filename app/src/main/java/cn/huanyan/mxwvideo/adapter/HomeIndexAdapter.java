...
public class HomeIndexAdapter extends BaseQuickAdapter<IndexBean.DataBeanX.DataBean, BaseViewHolder> {
    public HomeIndexAdapter(int layoutResId, @Nullable List<IndexBean.DataBeanX.DataBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, IndexBean.DataBeanX.DataBean item) {
