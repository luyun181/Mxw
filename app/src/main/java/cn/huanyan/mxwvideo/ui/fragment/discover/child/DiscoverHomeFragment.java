package cn.huanyan.mxwvideo.ui.fragment.discover.child;
 ...
 */
public class DiscoverHomeFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
...
//    private FirstHomeAdapter mAdapter;
  ...
  /*  private int[] mImgRes = new int[]{
    ...
    public static DiscoverHomeFragment newInstance() {
        ...
        DiscoverHomeFragment fragment = new DiscoverHomeFragment();
